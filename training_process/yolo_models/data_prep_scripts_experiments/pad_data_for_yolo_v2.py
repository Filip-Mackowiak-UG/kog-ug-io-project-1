...
for filename in os.listdir(directory):
    if filename.endswith(".jpg"):
        ...
        color = [random.randint(0, 255) for _ in range(3)]  # Random color for padding
        img = cv2.copyMakeBorder(img, pad_y, pad_y, pad_x, pad_x, cv2.BORDER_CONSTANT, value=color)
